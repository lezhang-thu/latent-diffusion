...
class DataModuleFromConfig(pl.LightningDataModule):
    def __init__(self, batch_size, f_name, frac):
        super().__init__()
    ...
    def setup(self, stage=None):
        ...
        gene_expression = gene_expression.reshape((-1, 128, 128, 1))
        self.datasets = dict()

        y = int(self.frac * len(gene_expression))
        y = y // self.batch_size * self.batch_size
...
if __name__ == "__main__":
    ...
    # running as `python x_main.py`
    # (in particular `x_main.DataModuleFromConfig`)
    ...
    try:
        ...
        default_callbacks_cfg = {
            ...
            "learning_rate_logger": {
                "target": "x_main.LearningRateMonitor",
                "params": {
